          ...
          {activeSection === "ceoMessage" && (
            <div className="story-content">
              ...
              <p>
                ...
                Construction Services & Facilities Procurement and Installation
                of resources for civil, mechanical and steel fabricated
                structures & finishing. Each project is of the highest
                importance to us just as it is to our treasured client. Over the
                last 1 decade, we at IRTAQA Design have maintained an upward
                graph for growth and sustainability into our emergence as one of
                the most well-reputed, well-recognized and a trustworthy brand
                name in the field of civil construction in Pakistan. Our clients
                are familiar with our transparent and partner like approach
                towards each project; free of costly delays, free of risk of
                conflict and guaranteed cost saving innovative construction
                methodologies approved and vetted by external Engineers and
                Consultants. At the heart of all our operations are our
                indispensable team members and work force, both on and off the
                ...
                diverse talents, skills and backgrounds at DCC. Working
                together, we make a positive difference and continue to make
                sure that every project is the envy of the Country. I pay
                tribute to all our workforce, who we consider as an integral
                part of IRTAQA Design family, for not only being a part of, but
                also determined and striving to work towards IRTAQA Design.
              </p>
            </div>
          )}
          {activeSection === "expertise" && (
            <div className="story-content">
              ...
              <p>
                ...
                building, infrastructure, interior designing, value engineering
                and project management. In over 8 years of experience we have
          ...
          {activeSection === "aboutUs" && (
            <div className="story-content">
              ...
              <p>
                ...
                multi-national organizations / investors, large prominent group
                of companies to start-ups looking for cost effective yet quality
                ...
                relationships built on strong foundations of trust, integrity
                and our capability to outperform targets. We believe in
                reinvesting in our teams, T&P and technology to deliver superior
                quality construction and engineering services to our treasured
                clients.
              </p>
